...
from Recommenders.MatrixFactorization.ALSRecommender import ALS
...
def __main__():
    ...
    hyperparameters_range_dictionary = {
        "factors": Integer(low=100, high=150),
        "regularization": Real(low=1e-4, high=1e-3, prior='log-uniform'),
        "iterations": Integer(low=25, high=50),
        "alpha": Real(low=2, high=7, prior='uniform'),
    }
