...
def __main__():
    ...
    recommender.save_model(folder_path="../result_experiments/", file_name="new_IALSRecommender_best_model80.zip")
    ...
    recommender.save_model(folder_path="../result_experiments/", file_name="new_IALSRecommender_best_model64.zip")
    ...
    recommender.save_model(folder_path="../result_experiments/", file_name="new_IALSRecommender_best_model100.zip")
