...
class MultVAERecommender(BaseRecommender, Incremental_Training_Early_Stopping, BaseTempFolder):
    ...
    def fit(self,
        ...
        self.vae = _MultVAE_original(self.p_dims, q_dims=q_dims, lr=self.learning_rate, lam=self.l2_reg,
                                     random_seed=98765)
...
class MultVAERecommender_OptimizerMask(MultVAERecommender):
    ...
    def fit(self, epochs=100, batch_size=500, total_anneal_steps=200000, learning_rate=1e-3, l2_reg=0.01,
            dropout=0.5, anneal_cap=0.2, encoding_size=50, next_layer_size_multiplier=2, max_parameters=np.inf,
        ...
        super(MultVAERecommender_OptimizerMask, self).fit(epochs=epochs, batch_size=batch_size, dropout=dropout,
                                                          learning_rate=learning_rate,
                                                          total_anneal_steps=total_anneal_steps, anneal_cap=anneal_cap,
                                                          p_dims=p_dims, l2_reg=l2_reg,
